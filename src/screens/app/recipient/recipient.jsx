...
import ListRecipients from './partials/list-recipients';
...
export default function Recipients() {
  ...
  const loadRegister = async () => {
    ...
    try {
      const res = await RecipientsAPI.Get()
    ...
    <SafeAreaView className="bg-primary-white">
      <View className="px-6">
        <View className="flex-row items-center justify-between pb-4 pt-2">
          <Text className="text-primary-gray2 text-2xl pt-2 font-bold">Destinatários</Text>
          <TouchableOpacity
        ...
        <InputIconSearch
          ...
          value={text}
          placeholder='Filtrar por destinatários'
